...
SPARKLOC_PAYMENT_TOKEN = PersistentConfig(
    "SPARKLOC_PAYMENT_TOKEN",
    "credit.sparkloc.payment_token",
    os.environ.get("SPARKLOC_PAYMENT_TOKEN", ""),
)

SPARKLOC_PAYMENT_ID = PersistentConfig(
    "SPARKLOC_PAYMENT_ID",
    "credit.sparkloc.payment_id",
    os.environ.get("SPARKLOC_PAYMENT_ID", ""),
)

SPARKLOC_CALLBACK_HOST = PersistentConfig(
    "SPARKLOC_CALLBACK_HOST",
    "credit.sparkloc.callback_host",
    os.environ.get("SPARKLOC_CALLBACK_HOST", ""),
)

CHECKIN_ENABLED = PersistentConfig(
    "CHECKIN_ENABLED",
    "credit.checkin.enabled",
    os.environ.get("CHECKIN_ENABLED", "True").lower() == "true",
)

CHECKIN_MIN_CREDIT = PersistentConfig(
    "CHECKIN_MIN_CREDIT",
    "credit.checkin.min_credit",
    os.environ.get("CHECKIN_MIN_CREDIT", "1"),
)

CHECKIN_MAX_CREDIT = PersistentConfig(
    "CHECKIN_MAX_CREDIT",
    "credit.checkin.max_credit",
    os.environ.get("CHECKIN_MAX_CREDIT", "5"),
)
