...
app.state.config.SPARKLOC_PAYMENT_TOKEN = SPARKLOC_PAYMENT_TOKEN
app.state.config.SPARKLOC_PAYMENT_ID = SPARKLOC_PAYMENT_ID
app.state.config.SPARKLOC_CALLBACK_HOST = SPARKLOC_CALLBACK_HOST
app.state.config.CHECKIN_ENABLED = CHECKIN_ENABLED
app.state.config.CHECKIN_MIN_CREDIT = CHECKIN_MIN_CREDIT
app.state.config.CHECKIN_MAX_CREDIT = CHECKIN_MAX_CREDIT
